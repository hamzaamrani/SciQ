...
def create_app(config_name):
    ...
    app.add_url_rule('/loggedUser', methods=['GET'], view_func=user_api.loggedUser)   

    from web.app.api import expression_api
    app.add_url_rule('/submit_expression', methods = ['POST'], view_func=expression_api.submit_expression)
    app.add_url_rule('/sendfile', methods = ['POST'], view_func=expression_api.send_file)
