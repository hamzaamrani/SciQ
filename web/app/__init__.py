...
def create_app(config_name):
    ...
    app.add_url_rule("/posts/user",
                     methods=['GET'],
                     view_func=community_api.get_posts)

    app.add_url_rule("/post",
                     methods=['POST', 'DELETE'],
                     view_func=community_api.post)

    app.add_url_rule("/post/<id>",
                     methods=['GET'],
                     view_func=community_api.get_post)

    app.add_url_rule('/comment',
                     methods=['POST'],
                     view_func=community_api.comment)
