...
def upgrade():
    ...
    op.drop_constraint(
        "user_expression_ibfk_2", "user_expression", type_="foreignkey"
    )
    op.drop_constraint(
        "user_expression_ibfk_1", "user_expression", type_="foreignkey"
    )
...
def downgrade():
    ...
    op.create_index(
        "user_id", "user_expression", ["user_id", "expression_id"], unique=True
    )
    # ### end Alembic commands ###
